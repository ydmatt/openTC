...
- `v1.0.15` 已完成代码、74/74 自动化测试、正式打包、独立启动/单实例转发烟雾测试及更新器黑盒测试。完整目录位于 `T:\mytc-releases\MYTC-v1.0.15-win-x64`，升级 ZIP 位于 `T:\mytc-updates\MYTC-v1.0.15-win-x64.zip`。此版本完成了此前登记的升级提示顺序、`Alt+Enter` 属性、新建文本文档命名、新建项目焦点和重命名选区优化。
